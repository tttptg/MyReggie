...
import com.ymc.reggie.entity.*;
import com.ymc.reggie.mapper.OrdersMapper;
import com.ymc.reggie.service.*;
...
public class OrdersServiceImpl extends ServiceImpl<OrdersMapper, Orders> implements OrdersService {
    ...
    public void again(Orders orders) {
        ...
        shoppingCartLambdaQueryWrapper.eq(ShoppingCart::getUserId,oldOrders.getUserId());
        shoppingCartService.remove(shoppingCartLambdaQueryWrapper);

        // 获取订单明细
        LambdaQueryWrapper<OrderDetail> orderDetailLambdaQueryWrapper = new LambdaQueryWrapper<>();
        orderDetailLambdaQueryWrapper.eq(OrderDetail::getOrderId,oldOrders.getId());
